...
#'  chunkDocument
#' 
#' This function takes as its parameters, a document in sentence tokenized
#' format and the chunk size in terms of numbers of sentences, and returns the 
#' document in a list of chunks, each chunk having the same number of sentences.
#' 
